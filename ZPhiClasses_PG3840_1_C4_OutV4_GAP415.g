...
##
##  ZPhiClasses_PG3840_1_C4_OutV4_GAP415.g
## @Claude Archer
##  Classes Z-phi pour
##
##      P = PerfectGroup(3840,1).
##
...
ZPhiClasses_PG3840_1_AllS := function(n)
    ...
    Print("ZPhiClasses_PG3840_1_AllS(", n, ")\n");
    Print("Applicable to PerfectGroup(3840,1)\n");
